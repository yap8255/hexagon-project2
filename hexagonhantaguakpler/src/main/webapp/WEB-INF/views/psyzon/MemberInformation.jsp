...
<meta property="og:url"
	content="http://www.payzon.co.kr/pzPersonnel/employeeIns.php?setEmplCode=031">
...
<script type="text/javascript" async=""
	src="https://www.googletagmanager.com/gtag/js?id=G-CCK8YDQV0H&amp;l=dataLayer&amp;cx=c"></script>
...
$( document ).ready( function() {
  ...
  $("#miliInfo").submit(function (event) {
    	  event.preventDefault();
    	  var mili = $("#miliInfo").serialize();
    	     // 서버로 데이터를 전송
          $.ajax({
              type: "POST",
              url: "/psyzon/updatemili",
              data: mili,
              success: function (data) {
                  // 서버 응답에 대한 처리
                  console.log(data);
  ...
  $.fn.getPayzonQuick = function() {
    ...
    return;
		...
		<div class="jbMenu jbFixed" style="text-align: left; color: #FFFFFF;">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* 현재 고객님은 체험판 이용중 이십니다. 월 12,000원으로
			급여관리 자동화 페이존(PAYZON)의 모든 서비스를 자유롭게 이용하실 수 있습니다. <a
				href="/pzServiceGuide/php/inLogoutProc.php?ref=ExZon"><span
				style="color: #FFFFFF;">[회원가입]</span></a>
		</div>
		<div id="main_header">
			<div class="header">
				<ul class="logo p_t10">
					<a href="/"><img
						src="https://img.payzon.co.kr/_commonImg/header_logo_lt.png"></a>
					<a href="/pzServiceInfo/serviceInfo.php?ref=pzLogo"><img
						src="https://img.payzon.co.kr/_commonImg/header_logo_rt.png"></a>
				</ul>
				<ul class="logInfo">고객님 무료체험회원 입니다.
				</ul>
				<ul class="login_menu">
					<div class="direct">
					...
					<div class="favorite">
						<span id="btnBookmark" onclick="$.fn.setBookmark();"
							class="anchor"><img
							src="https://img.payzon.co.kr/_commonImg/icon_fa.gif"
							alt="즐겨찾기 추가" title="즐겨찾기 추가"></span> <a
							href="javascript:$.fn.getPayzonQuick();"><img
							src="https://img.payzon.co.kr/_commonImg/icon_go.gif"
							alt="바탕화면바로가기" title="바탕화면바로가기"></a>
					</div>
					<!--<div class='print'><a href='#'><img src='https://img.payzon.co.kr/_commonImg/top_direct_print.png' alt='인쇄' title='인쇄'></a></div>-->
				</ul>
			</div>
		</div>
	</header>
		...
		<div id="top_gnb_2017">
			<div class="navi_2017">
				<ul class="navi_L_2017">
					<li class="n01"><a
						href="/pzServiceInfo/serviceInfo.php?ref=home"
						title="[Shift + 1] HOME"><span id="SK01">HOME</span></a></li>
					<li class="n02"><a href="/pzPersonnel/employeeIns.php"
						title="[Shift + 2] 사원등록"><span id="SK02">사원등록</span></a></li>
					<li class="n03"><a href="/pzPersonnel/employeeMnt.php"
						title="[Shift + 3] 사원현황"><span id="SK03">사원현황</span></a></li>
					<li class="n04"><a
						href="/pzPersonnel/certificatePrintWorking.php"
						title="[Shift + 4] 제 증명서 발급"><span id="SK04">제 증명서 발급</span></a></li>
					<li class="n05"><a href="/pzDiligence/diligenceMnt.php"
						title="[Shift + 5] 근태기록/관리"><span id="SK05">근태기록/관리</span></a></li>
					<li class="n06"><a
						href="/pzDiligence/holidaysSearchResult.php"
						title="[Shift + 6] 휴가조회"><span id="SK06">휴가조회</span></a></li>
					<li class="n07"><a
						href="/pzPayment/paymentMnt.php?frmPmsvTurmYYYY=2023&amp;frmPmsvTurmMM=12&amp;frmPmsvTurmCh=01&amp;setPmsvType=0"
						title="[Shift + 7] 급여입력/관리"><span id="SK07">급여입력/관리</span></a></li>
					<li class="n08"><a
						href="/pzPayment/paymentMntDayWorker.php?frmPmsvTurmYYYY=2023&amp;frmPmsvTurmMM=12&amp;frmPmsvTurmCh=01"
						title="[Shift + 8] 급여입력/관리(일용직)"><span id="SK08">급여입력/관리(일용직)</span></a></li>
					<li class="n09"><a href="/pzPayment/paymentRegisterList.php"
						title="[Shift + 9] 급여대장"><span id="SK09">급여대장</span></a></li>
					<li class="n10"><a
						href="/pzPayment/paymentPayslip.php?frmPmsvTurmYYYY=2023&amp;frmPmsvTurmMM=12&amp;frmPmsvTurmCh=01"
						title="[Shift + 0] 급여명세서"><span id="SK10">급여명세서</span></a></li>
					<li class="n11"><a href="/pzPayment/paymentPayList.php"
						title="[Shift + -] 사원별급여내역"><span id="SK11">사원별급여내역</span></a></li>
					<li class="n12"><a href="/pzPayment/withHoldingTax.php"
						title="[Shift + =] 월천징수부"><span id="SK12">월천징수부</span></a></li>
					...
					<li class="n15"><a href="/pzMyPage/onlineQnAEdit.php"><span>온라인
								문의</span></a></li>
				</ul>
			</div>
		</div>
		...
		<div id="bottom_gnb2017">
			<div id="menu" class="menu2020">
				<ul class="menu_s2020">
					...
					<li class="n01"><a href="/pzConfig/membersInfo.php"><span>기본환경설정</span></a>
					...
					<li class="n02"><a href="/pzPersonnel/employeeMnt.php"><span>인사관리</span></a>
						<div class="menu_2depth_01_2020 " style="z-index: 9999;">
							<ul class="menu_01">
								<li><a href="/pzPersonnel/employeeMnt.php">사원현황/관리</a></li>
								<li><a href="/pzPersonnel/employeeCard.php">인사기록 카드</a></li>
								<li><a href="/pzPersonnel/certificatePrintWorking.php">제
										증명서 발급</a></li>
								<li><a href="/pzPersonnel/certificateRegister.php">제
										증명서 발급대장</a></li>
							</ul>
						</div></li>
					<!--a:hover시엔 top값을 수정해서 사용-->

					<li class="n03"><a href="/pzDiligence/diligenceMnt.php"><span>근태관리</span></a>
						<div class="menu_2depth_01_2020 " style="z-index: 9999;">
							<ul class="menu_01">
								...
								<li><a href="/pzDiligence/holidaysSearchResult.php">휴가조회</a></li>
								<!-- /pzDiligence/holidaysSearch.php -->
								<li><a href="/pzDiligence/dayWorkerMnt.php">일용직 근무기록/관리</a></li>
								<li><a href="/pzDiligence/dayWorkerSearchMonth.php">일용직
										근무 조회</a></li>
							</ul>
						</div></li>

					<li class="n04"><a
						href="/pzPayment/paymentMnt.php?frmPmsvTurmYYYY=2023&amp;frmPmsvTurmMM=12&amp;frmPmsvTurmCh=01&amp;setPmsvType=0"><span>급여관리</span></a>
						<div class="menu_2depth_01_2020 " style="z-index: 9999;">
							<ul class="menu_01">
								<!-- <li><a href="/pzConfig/payItemSet.php">급여항목 설정</a></li>-->
								<li><a
									href="/pzPayment/paymentMnt.php?frmPmsvTurmYYYY=2023&amp;frmPmsvTurmMM=12&amp;frmPmsvTurmCh=01&amp;setPmsvType=0">급여입력/관리</a></li>
								<li><a
									href="/pzPayment/paymentMntDayWorker.php?frmPmsvTurmYYYY=2023&amp;frmPmsvTurmMM=12&amp;frmPmsvTurmCh=01">급여입력/관리(일용직)</a></li>
								<li><a href="/pzPayment/paymentRegisterList.php">급여대장</a></li>
								<li><a
									href="/pzPayment/paymentPayslip.php?frmPmsvTurmYYYY=2023&amp;frmPmsvTurmMM=12&amp;frmPmsvTurmCh=01">급여명세서</a></li>
								<!-- /pzPayment/paymentPayslip.php -->
								<li><a href="/pzPayment/paymentPayList.php">사원별 급여내역</a></li>
								<li><a href="/pzPayment/paymentTransfer.php">급여이체 신청</a></li>
								<li><a href="/pzPayment/paymentTransferList.php">급여이체
										결과조회</a></li>
								<li><a href="/pzPayment/paymentPayItemPart.php">항목별 대장</a></li>
								<li><a
									href="/pzPayment/4insureList.php?setPmsvTurmYYYY=2023&amp;setPmsvTurmMM=12&amp;setPmsvTurmCh=01">4대보험
										공제내역</a></li>
								<!--
                  ...
                  <li class="height"><a href="/pzPayment/dayWorkerPayslipSave.php">일용근로소득 지급명세서<br />(원천징수영수증)</a></li>-->
					...
					<li class="n07"><a
						href="/pzStatistics/paymentStatisticsAll.php"><span>급여통계</span></a>
						<div class="menu_2depth_01_2020" style="z-index: 9999;">
							<ul class="menu_01">
								<li><a href="/pzStatistics/paymentStatisticsAll.php">연도별
										전체급여 통계</a></li>
								<li><a href="/pzStatistics/paymentStatisticsAllMonth.php">월별
										전체급여 통계</a></li>
								<li><a href="/pzStatistics/paymentStatistics.php">연도별
										개인연봉 통계</a></li>
								<li><a href="/pzStatistics/paymentStatisticsMonth.php">월별
										개인급여 통계</a></li>
								<li><a href="/pzStatistics/paymentStatisticsPayItems.php">급여항목
										구성 통계</a></li>
							</ul>
						</div></li>

					<li class="n05"><a href="/pzRetirement/retireProcess.php"><span>퇴직관리</span></a>
						<div class="menu_2depth_01_2020" style="z-index: 9999;">
							<ul class="menu_01">
								<li><a href="/pzRetirement/retireProcess.php">사원 퇴직처리</a></li>
								<li><a href="/pzRetirement/retirementMnt.php">퇴직급여
										입력/관리</a></li>
								<li><a href="/pzRetirement/retirePayslip.php">퇴직급여명세서</a></li>
								<!-- <li><a href="/pzRetirement/retireReceipt.php">퇴직소득원천징수영수증</a></li>-->
							</ul>
						</div></li>
					<li class="n06"><a href="/pzPayment/withHoldingTax.php"><span>세무관리</span></a>
						<div class="menu_2depth_01_2020 " style="z-index: 9999;">
							<ul class="menu_01">
								<li><a href="/pzPayment/withHoldingTax.php">근로소득 원천징수부</a></li>
								<li><a href="/pzPayment/dayWorkerPayslipV2.php">일용근로소득
										지급명세서</a></li>
								<li><a href="/pzRetirement/retireReceipt.php">퇴직소득원천징수영수증</a></li>
	...
	<section>
		...
		<div id="main_container">
			...
			<div class="sub_titimg">
				<ul>
					<li class="tit_img p_r7"><img
						src="https://img.payzon.co.kr/_commonImg/eadmin_tit_img.gif"
						width="70" height="68"></li>
					<li class="p_t10  "><img
						src="https://img.payzon.co.kr/_commonImg/emreg_tit_01.gif"
						width="108" height="24" alt="사원등록" title="사원등록"></li>
					<li class="p_t5 ">사원정보를 등록하는 메뉴입니다. 해당되는 항목만 입력하시면 됩니다. <span
						class="tit_h">(* 표시는 필수 입력사항)</span>
					</li>
				</ul>
			...
			<div class="main_titimg">
				...
				<!-- //스크롤 레이어 Start -->
				<div class="emreg_lt01" style="position: absolute; top: 270px;"
					id="QuickTop">
					<!--  -->
					<ul>
						<div class="emreg_lt">
							<ul class="em_photo w_120">
								<li class="border_box b_gray ph"><img
									id="disEmployeeDefaultImg"
									src="/_employeePhoto/5774/Thumb/577388_HM.jpg" alt="등록"
									title="등록" style="height: 117px;" vspace="10"></li>
								<!-- ID:disEmployeeDefaultImg, alt:Info -->
								<li class="p_t10 c"><input name="btnEmplPhotoIns"
									id="btnEmplPhotoIns" type="button" value="등록" class="btn">
									<input name="btnEmplPhotoDel" id="btnEmplPhotoDel"
									type="button" value="삭제" class="btn"></li>
							</ul>
							<ul>
								<li>
									<div class="emreg_table w_170">
										<ul class="border_emreg">
											...
											<li class="p_l5" style="width: 87px;"><strong><span
													id="disEmplNmbr">No-140034</span></strong></li>
										</ul>
										<ul>
											<li class="w_60 tit_y">성명</li>
											<li class="p_l5" style="width: 87px;"><strong><span
													id="disEmplName">이응열</span></strong></li>
										</ul>
										<ul>
											<li class="w_60 tit_y">부서</li>
											<li class="p_l5" style="width: 87px;"><span
												id="disEprtName">사장실</span></li>
										</ul>
										<ul>
											<li class="w_60  tit_y">직위</li>
											<li class="p_l5" style="width: 87px;"><span
												id="disPstnName">사장</span></li>
										</ul>
										<ul>
											<li class="w_60  tit_y">입사일</li>
											<li class="p_l5" style="width: 87px;"><span
												id="disEmplJndt">2000-02-22</span></li>
										</ul>
									</div>
								</li>
								<li class="c"><input name="btnEmplCardGo"
									id="btnEmplCardGo" type="button" value="인사기록카드" class="btn"></li>
							</ul>
						</div>
						<div class="emreg_lt_addinfo">
							...
							<ul>
								<img
									src="https://img.payzon.co.kr/_commonImg/emreg_addinfo_tit01.gif"
									width="330px" height="30px" vspace="10">
							</ul>
							<ul class="tab" id="iconMenuGroup">
								<li><a href="#aTagMenu01"><img
										src="https://img.payzon.co.kr/_commonImg/emreg_btn02.gif"
										onmouseover="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn02_on.gif&quot;"
										onmouseout="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn02.gif&quot;"
										width="95px" height="51px" vspace="3" border="0" alt="급여/4대보험"
										title="급여/4대보험"></a></li>
								<li><a href="#aTagMenu02"><img
										src="https://img.payzon.co.kr/_commonImg/emreg_btn03.gif"
										onmouseover="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn03_on.gif&quot;"
										onmouseout="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn03.gif&quot;"
										width="95px" height="51px" vspace="3" hspace="10" border="0"
										alt="부양가족" title="부양가족"></a></li>
								<li><a href="#aTagMenu03"><img
										src="https://img.payzon.co.kr/_commonImg/emreg_btn04.gif"
										onmouseover="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn04_on.gif&quot;"
										onmouseout="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn04.gif&quot;"
										width="95px" height="51px" vspace="3" border="0" alt="학력"
										title="학력"></a></li>
								<li><a href="#aTagMenu04"><img
										src="https://img.payzon.co.kr/_commonImg/emreg_btn05.gif"
										onmouseover="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn05_on.gif&quot;"
										onmouseout="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn05.gif&quot;"
										width="95px" height="51px" vspace="3" border="0" alt="경력"
										title="경력"></a></li>
								<li><a href="#aTagMenu05"><img
										src="https://img.payzon.co.kr/_commonImg/emreg_btn06.gif"
										onmouseover="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn06_on.gif&quot;"
										onmouseout="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn06.gif&quot;"
										width="95px" height="5px" vspace="3" hspace="10" border="0"
										alt="병역" title="병역"></a></li>
							</ul>
							<ul>
								<!--<a href="#none" onclick="javascript:$.fn.goMove('etc_00');">-->
								<img
									src="https://img.payzon.co.kr/_commonImg/emreg_addinfo_tit02.gif"
									width="330px" height="30px" vspace="10" border="0">
							</ul>
							<ul class="tab">
								<li><span class="anchor"
									onclick="javascript:$.fn.goMove('etc_07');"><img
										src="https://img.payzon.co.kr/_commonImg/emreg_btn07.gif"
										onmouseover="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn07_on.gif&quot;"
										onmouseout="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn07.gif&quot;"
										width="95px" height="51px" vspace="3" border="0" alt="자격/면허"
										title="자격/면허"></span></li>
								<li><span class="anchor"
									onclick="javascript:$.fn.goMove('etc_08');"><img
										src="https://img.payzon.co.kr/_commonImg/emreg_btn08.gif"
										onmouseover="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn08_on.gif&quot;"
										onmouseout="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn08.gif&quot;"
										width="95px" height="51px" vspace="3" hspace="10" border="0"
										alt="교육/훈련" title="교육/훈련"></span></li>
								<li><span class="anchor"
									onclick="javascript:$.fn.goMove('etc_09');"><img
										src="https://img.payzon.co.kr/_commonImg/emreg_btn09.gif"
										onmouseover="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn09_on.gif&quot;"
										onmouseout="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn09.gif&quot;"
										width="95px" height="51px" vspace="3" border="0" alt="상벌"
										title="상벌"></span></li>
								<li><span class="anchor"
									onclick="javascript:$.fn.goMove('etc_10');"><img
										src="https://img.payzon.co.kr/_commonImg/emreg_btn10.gif"
										onmouseover="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn10_on.gif&quot;"
										onmouseout="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn10.gif&quot;"
										width="95px" height="51px" vspace="3" border="0" alt="발령"
										title="발령"></span></li>
								<li><span class="anchor"
									onclick="javascript:$.fn.goMove('etc_11');"><img
										src="https://img.payzon.co.kr/_commonImg/emreg_btn11.gif"
										onmouseover="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn11_on.gif&quot;"
										onmouseout="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn11.gif&quot;"
										width="95px" height="51px" vspace="3" hspace="10" border="0"
										alt="추천/신원보증" title="추천/신원보증"></span></li>
								<li><span class="anchor"
									onclick="javascript:$.fn.goMove('etc_12');"><img
										src="https://img.payzon.co.kr/_commonImg/emreg_btn12.gif"
										onmouseover="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn12_on.gif&quot;"
										onmouseout="this.src=&quot;https://img.payzon.co.kr/_commonImg/emreg_btn12.gif&quot;"
										width="95px" height="51px" vspace="3" border="0" alt="퇴직"
										title="퇴직"></span></li>
							</ul>
							<!-- 아이콘 메뉴 End -->
							<hr class="hr_5">
				...
				<!-- //레이어 메뉴 대체 Object -->
				<div class="emreg_lt01">
					<img src="/_commonImg/1px.png" height="1px">
				</div>
				<!-- //레이어 메뉴 대체 Object// -->
			...
			<div class="emreg_rt">
				...
				<input name="frmSetMode" id="frmSetMode" type="hidden"
					value="setUpd"> <input name="frmEmplCode" id="frmEmplCode"
					type="hidden" value="31"> <input name="frmEmplIndx"
					id="frmEmplIndx" type="hidden" value="1171353">
				<!-- //폼.입력.기본정보 -->
				<ul id="lblBsic">
					<img src="https://img.payzon.co.kr/_commonImg/emreg_tit_02.gif"
						width="63px" height="19px" vspace="8" hspace="5" border="0"
						alt="기본정보" title="기본정보">
				</ul>
				<ul>
					<div id="table1">
						...
						<ul>
							...
							<li class="w_276 con2"><select name="memberlist.m_type"
								id="frmEmplEmpl">
									...
									<option value="정규직"
										<c:if test="${MemberInfo.memberinfovo.m_type eq '정규직'}">selected=""</c:if>>정규직</option>
									<option value="계약직"
										<c:if test="${MemberInfo.memberinfovo.m_type eq '계약직'}">selected=""</c:if>>계약직</option>
									<option value="임시직"
										<c:if test="${MemberInfo.memberinfovo.m_type eq '임시직'}">selected=""</c:if>>임시직</option>
									<option value="파견직"
										<c:if test="${MemberInfo.memberinfovo.m_type eq '파견직'}">selected=""</c:if>>파견직</option>
									<option value="위촉직"
										<c:if test="${MemberInfo.memberinfovo.m_type eq '위촉직'}">selected=""</c:if>>위촉직</option>
									<option value="일용직"
										<c:if test="${MemberInfo.memberinfovo.m_type eq '일용직'}">selected=""</c:if>>일용직</option>
							</select></li>
						</ul>
						<ul>
							<li class="titLeft p_l15" style="width: 90px;"><font
						...
						<ul>
							...
							<li class="w_275 con2"><select name="memberlist.m_class"
								...
								<div class="img">
									<span class="anchor"><img name="idCmpnDprtSet"
										id="idCmpnDprtSet"
										src="https://img.payzon.co.kr/_commonImg/btn_settingadmin.png"
							...
							<li class="w_276 con2"><select name="memberlist.m_position"
								...
								<div class="img">
									<span class="anchor"><img name="idCmpnPstnSet"
										id="idCmpnPstnSet"
										src="https://img.payzon.co.kr/_commonImg/btn_settingadmin.png"
										width="42px" height="20px" alt="부서명 관리" title="부서명 관리"></span>
								</div></li>
...
-->
						...
						<ul>
							...
							<li class="w_275 con2"><select name="information.l_tellephone1"
								id="frmEmplTel1">
									...
									<option value="00"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '대표(없음)'}">selected=""</c:if>>대표(없음)</option>
									<option value="050"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '050'}">selected=""</c:if>>인터넷(050)</option>
									<option value="0507"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '0507'}">selected=""</c:if>>인터넷(0507)</option>
									<option value="070"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '070'}">selected=""</c:if>>인터넷(070)</option>
									<option value="0303"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '0303'}">selected=""</c:if>>인터넷(0303)</option>
									<option value="0504"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '0504'}">selected=""</c:if>>인터넷(0504)</option>
									<option value="02"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '02'}">selected=""</c:if>>서울(02)</option>
									<option value="051"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '051'}">selected=""</c:if>>부산(051)</option>
									<option value="053"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '053'}">selected=""</c:if>>대구(053)</option>
									<option value="032"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '032'}">selected=""</c:if>>인천(032)</option>
									<option value="062"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '062'}">selected=""</c:if>>광주(062)</option>
									<option value="042"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '042'}">selected=""</c:if>>대전(042)</option>
									<option value="052"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '052'}">selected=""</c:if>>울산(052)</option>
									<option value="044"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '044'}">selected=""</c:if>>세종(044)</option>
									<option value="031"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '031'}">selected=""</c:if>>경기(031)</option>
									<option value="033"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '033'}">selected=""</c:if>>강원(033)</option>
									<option value="043"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '043'}">selected=""</c:if>>충북(043)</option>
									<option value="041"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '041'}">selected=""</c:if>>충남(041)</option>
									<option value="063"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '063'}">selected=""</c:if>>전북(063)</option>
									<option value="061"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '061'}">selected=""</c:if>>전남(061)</option>
									<option value="054"
										<c:if test="${MemberInfo.memberinfovo.l_tellephone1 eq '054'}">selected=""</c:if>>경북(054)</option>
									<option value="055"
							...
							<li class="w_276 con2"><select name="information.l_phone1"
								id="frmEmplPho1">
									...
									<option value="010"
										<c:if test="${MemberInfo.memberinfovo.l_phone1 eq '010'}">selected=""</c:if>>010</option>
									<option value="011"
										<c:if test="${MemberInfo.memberinfovo.l_phone1 eq '011'}">selected=""</c:if>>011</option>
									<option value="016"
										<c:if test="${MemberInfo.memberinfovo.l_phone1 eq '016'}">selected=""</c:if>>016</option>
									<option value="017"
										<c:if test="${MemberInfo.memberinfovo.l_phone1 eq '017'}">selected=""</c:if>>017</option>
									<option value="018"
				...
				<ul>
					<img
						src="https://img.payzon.co.kr/_commonImg/emreg_addinfo_tit01_01.gif"
						width="800px" height="27px" alt="사원정보 1" title="사원정보 1">
				</ul>
 ...
 <!--    <ul>
    ...
    //급여: G1// -->
				     ...
				     <ul>
      <div id="table1">
      <form:form modelAttribute="UpdatePaymentVO" action="/psyzon/insertpayment" method = "post" id = "paymentInfo">
      ...
      <ul>
        ...
        <li class="con2" style="width:630px;">
          <label class="label_check c_on" for="frmEmp4Insu1" style="float:left;margin-top:6px;margin-right:40px;"><input name="payment[${status.index}].p_national_pension" id="frmEmp4Insu1" value="1" type="checkbox" class="G1"<c:if test="${MemberInfo.p_national_pension eq 1}">checked=""</c:if>> 국민연금</label>
          <label class="label_check c_on" for="frmEmp4Insu2" style="float:left;margin-top:6px;"><input name="payment[${status.index}].p_health_insurance" id="frmEmp4Insu2" value="2" type="checkbox" <c:if test="${MemberInfo.p_health_insurance eq 1}">checked=""</c:if> class="G1"> 건강보험</label>

          <span class="select_front" style="float:left;margin-top:6px;">(감면:</span>
          <select name="payment[${status.index}].p_hi_discount" id="selEmp4HIDc" class="G1" style="float:left;margin-top:1px;">
          ...
          <span class="select_front" style="float:left;margin-top:6px;">(감면:</span>
          <select name="payment[${status.index}].p_longterm_discount" id="selEmp4LTCI" class="G1" style="float:left;margin-top:1px;">
          ...
          <label class="label_check" for="frmEmp4Insu3" style="margin-top:6px;"><input name="payment[${status.index}].p_employment_insurance" id="frmEmp4Insu3" value="4" type="checkbox" class="G1"<c:if test="${MemberInfo.p_employment_insurance eq 1}">checked=""</c:if>> 고용보험</label>
        </li>
      </ul>
      <ul>
        ...
        <li class="con2" style="width:630px;height:51px;">
          <div class="top-5">
            <label class="label_radio r_on" for="frmEmp4Ict1" style="float:left;"><input name="payment[${status.index}].p_sudden_tax" id="frmEmp4Ict1" type="radio" value="1"class="G1"<c:if test="${MemberInfo.p_sudden_tax eq 1}">checked=""</c:if>>근로소득자(근로소득간이세액표)</label>&nbsp;&nbsp; <span style="float:left; display:block; margin:6px 5px 0 10px;">세액:</span>
            <select name="payment[${status.index}].p_lei_discount" id="frmEmp4TxRt" style="float:left;width:68px;" class="G1">
            ...
            <label class="label_check" for="chkEmp4TxYM" style="float:left; margin:6px 10px -2px 26px;"><input name="payment[${status.index}].p_medium_business_discount" id="chkEmp4TxYM" type="checkbox" value="1" class="G1" <c:if test="${MemberInfo.p_medium_business_discount eq 1}">checked=""</c:if>style="vertical-align:middle; margin-top:2px;">중소기업 청년 소득세 감면</label>&nbsp;&nbsp;
            <select name="payment[${status.index}].p_tax" id="selEmp4TxYM" style="float:left;width:68px;margin-top:1px;" class="G1">
            ...
            <br>
            <label class="label_radio" for="frmEmp4Ict2"><input name="payment[${status.index}].p_sudden_tax" id="frmEmp4Ict2" type="radio" value="2" class="G1"<c:if test="${MemberInfo.p_sudden_tax eq 2}">checked=""</c:if>>사업소득자(3.3%)</label>&nbsp;&nbsp;
            <label class="label_radio" for="frmEmp4Ict3"><input name="payment[${status.index}].p_sudden_tax" id="frmEmp4Ict3" type="radio" value="3" class="G1"<c:if test="${MemberInfo.p_sudden_tax eq 3}">checked=""</c:if>>일용직(2.97%)</label>&nbsp;&nbsp;
            <label class="label_radio" for="frmEmp4Ict6"><input name="payment[${status.index}].p_sudden_tax" id="frmEmp4Ict6" type="radio" value="4" class="G1"<c:if test="${MemberInfo.p_sudden_tax eq 4}">checked=""</c:if>>기타소득자(8.8%)</label>&nbsp;&nbsp;
            <label class="label_radio" for="frmEmp4Ict5"><input name="payment[${status.index}].p_sudden_tax" id="frmEmp4Ict5" type="radio" value="5" class="G1"<c:if test="${MemberInfo.p_sudden_tax eq 5}">checked=""</c:if>>근로/사업소득자</label>&nbsp;&nbsp;
            <label class="label_radio" for="frmEmp4Ict4"><input name="payment[${status.index}].p_sudden_tax" id="frmEmp4Ict4" type="radio" value="6" class="G1"<c:if test="${MemberInfo.p_sudden_tax eq 6}">checked=""</c:if>>면제</label>
          </div>
        </li>
      </ul>
      <ul>
        ...
        <li class="con2" style="width:630px;height:63px;">
          <div id="durunuriMerge" class="top-5">
            <label class="label_radio r_on" for="rdoDurunuri00"><input name="payment[${status.index}].p_dorunuri" id="rdoDurunuri00" value="0" type="radio"class="G1"<c:if test="${MemberInfo.p_dorunuri eq 1}">checked=""</c:if>> 해당 없음   </label>&nbsp;&nbsp;
            ...
            <label class="label_radio" for="rdoDurunuri03"><input name="payment[${status.index}].p_dorunuri" id="rdoDurunuri03" value="3" type="radio" class="G1"<c:if test="${MemberInfo.p_dorunuri eq 3}">checked=""</c:if>> 신규가입자(80% 지원)</label>&nbsp;&nbsp;
            <label class="label_radio" for="rdoDurunuri04"><input name="payment[${status.index}].p_dorunuri" id="rdoDurunuri04" value="4" type="radio" class="G1"<c:if test="${MemberInfo.p_dorunuri eq 4}">checked=""</c:if>> 신규가입자(90% 지원)</label>&nbsp;&nbsp;
      ...
      <ul>
        ...
        <li class="con2" style="width:250px;"><input name="payment[${status.index}].p_nomal_payment" id="frmEmp4PayB" type="text" value="${MemberInfo.p_nomal_payment}" class="money G1" style="width:80%;"> 원</li>
    ...
    <ul>
     <li class="titLeft p_l15" style="width:135px;">국민연금 기준소득월액</li>
        <li class="con2" style="width:250px;"><input name="payment[${status.index}].p_national_i_payment" id="frmEmp4Inco" type="text" value="${MemberInfo.p_national_i_payment}" class="money G1" style="width:80%;"> 원</li>
 ...
 미입력시 해당 근속월의 비과세를 제외한 과세합계로 적용됩니다.</li>
      ...
      <ul style="width:419px;">
        ...
        <li class="con2" style="width:250px;"><input name="payment[${status.index}].p_health_i_payment" id="frmEmp4PyM1" type="text" value="${MemberInfo.p_health_i_payment}" class="money G1" style="width:80%;"> 원</li>
  </ul>
  <ul style="width:419px;">
        <li class="titLeft p_l15" style="width:135px;">고용보험 보수월액</li>
        <li class="con2" style="width:250px;"><input name="payment[${status.index}].p_employment_i_payment" id="frmEmp4PyM2" type="text" value="${MemberInfo.p_employment_i_payment}" class="money G1" style="width:80%;"> 원</li>
      </ul>
      <ul>
        <li class="titLeft p_l15" style="width:135px;">급여계좌</li>
        <li class="con2" style="width:630px;">
          <select name="payment[${status.index}].p_payment_bank" id="frmEmp4BkNm" class="G1">
	...
	<option value="SK증권"<c:if test="${MemberInfo.p_payment_bank eq 'SK증권' }">selected</c:if>>SK증권</option>
          ...
          <input name="payment[${status.index}].p_bank_number" id="frmEmp4BkNb" type="text" value="${MemberInfo.p_bank_number}" class="text G1" maxlength="25" style="width:190px;" placeholder="계좌번호">
    ...
    <hr class="hr_0">
				...
				<ul class="p_b5 c_blue ">
					<strong><span class="c_red b ">+</span> 4대보험</strong>
				</ul>
				<ul>
					...
					<div id="table1">
						...
						<form:form modelAttribute="UpdateInsuranceVO"
							action="/psyzon/updateinsurance" method="post" id="insuranceInfo">
							<input type="hidden" name="insurance.m_number" value="${MemberInfo.insurancevo.m_number}">
							<ul>

								<li class="w_105 tit_s c">국민연금</li>
								<!-- national pension -->

								<li class="w_330 con3"><input name="insurance.k_number"
									id="frmEm4iInNbNP" type="text"
									value="${MemberInfo.insurancevo.k_number}" class="white G2"
									maxlength="20"></li>
								<li class="w_180 con3"><input name="insurance.k_date"
									id="frmEm4iInDSNP" type="text"
									value="${MemberInfo.insurancevo.k_date}"
									class="white G2 frmCalendar c hasDatepicker" maxlength="10"></li>
								<li class="w_180 con3"><input name="insurance.nk_date"
									id="frmEm4iInDENP" type="text"
									value="${MemberInfo.insurancevo.nk_date}"
									class="white G2 frmCalendar c hasDatepicker" maxlength="10"></li>
							...
							<ul>
								<li class="w_105 tit_s c">건강보험</li>
								<!-- health insurance -->
								<li class="w_330 con3"><input name="insurance.h_number"
									id="frmEm4iInNbHI" type="text"
									value="${MemberInfo.insurancevo.h_number}" class="white G2"
									maxlength="20"></li>
								<li class="w_180 con3"><input name="insurance.h_date"
									id="frmEm4iInDSHI" type="text"
									value="${MemberInfo.insurancevo.h_date}"
									class="white G2 frmCalendar c hasDatepicker" maxlength="10"></li>
								<li class="w_180 con3"><input name="insurance.nh_date"
									id="frmEm4iInDEHI" type="text"
									value="${MemberInfo.insurancevo.nh_date}"
									class="white G2 frmCalendar c hasDatepicker" maxlength="10"></li>
							</ul>
							...
							<ul>
								<li class="w_105 tit_s c">고용보험</li>
								<!-- unemployment insurance -->
								<li class="w_330 con3"><input name="insurance.e_number"
									id="frmEm4iInNbUI" type="text"
									value="${MemberInfo.insurancevo.e_number}" class="white G2"
									maxlength="20"></li>
								<li class="w_180 con3"><input name="insurance.e_date"
									id="frmEm4iInDSUI" type="text"
									value="${MemberInfo.insurancevo.e_date}"
									class="white G2 frmCalendar c hasDatepicker" maxlength="10"></li>
								<li class="w_180 con3"><input name="insurance.ne_date"
									id="frmEm4iInDEUI" type="text"
									value="${MemberInfo.insurancevo.ne_date}"
									class="white G2 frmCalendar c hasDatepicker" maxlength="10"></li>
							</ul>

							<ul>
								<li class="w_105 tit_s c">산재보험</li>
								<!-- safety insurance -->
								<li class="w_330 con3"><input name="insurance.i_number"
									id="frmEm4iInNbSI" type="text"
									value="${MemberInfo.insurancevo.i_number}" class="white G2"
									maxlength="20"></li>
								<li class="w_180 con3"><input name="insurance.i_date"
									id="frmEm4iInDSSI" type="text"
									value="${MemberInfo.insurancevo.i_date}"
									class="white G2 frmCalendar c hasDatepicker" maxlength="10"></li>
								<li class="w_180 con3"><input name="insurance.ni_date"
									id="frmEm4iInDESI" type="text"
									value="${MemberInfo.insurancevo.ni_date}"
									class="white G2 frmCalendar c hasDatepicker" maxlength="10"></li>
							</ul>
				...
				<!-- //부양가족: G3-->
				<ul id="lblDepe">
					<img src="https://img.payzon.co.kr/_commonImg/emreg_tit_04.gif"
						width="65px" height="19px" vspace="8" hspace="5" border="0"
						alt="부양가족" title="부양가족">
					<span class="f_right  p_t5"><input name="btnDepeAdd"
						id="btnDepeAdd" type="image" value="추가하기"
						src="https://img.payzon.co.kr/_commonImg/btn_plus.gif"
						width="54px" height="21px" alt="추가하기">&nbsp;<input
						name="btnDepeDel" id="btnDepeDel" type="image" value="선택삭제"
						src="https://img.payzon.co.kr/_commonImg/btn_s_delete.gif"
					...
					<div id="table1">
						...
						<ul>
							<li class="w_24 tit"><label class="label_check"
								for="chkBoxGrpDepe"><input id="chkBoxGrpDepe"
							...
							<li class="w_60 tit">갑근세 <img
								src="https://img.payzon.co.kr/_commonImg/icon_help_s.gif"
								width="12"
								title=" 갑근세(소득세, 지방소득세) 계산을 위한 항목으로 체크시
[급여 입력/관리]에서 소득세 산정에 해당 부양가족이 반영됩니다.
부양가족 정보를 입력하셨더라도
이 항목을 체크하지 않을 경우 급여 산정에는 반영되지 않습니다."
								alt=" 갑근세(소득세, 지방소득세) 계산을 위한 항목으로 체크시
[급여 입력/관리]에서 소득세 산정에 해당 부양가족이 반영됩니다.
부양가족 정보를 입력하셨더라도
이 항목을 체크하지 않을 경우 급여 산정에는 반영되지 않습니다."></li>
							<li class="w_70 tit">다자녀 <img
								src="https://img.payzon.co.kr/_commonImg/icon_help_s.gif"
								width="12"
								title=" 갑근세 계산을 위한 항목으로
기본공제대상자에 해당하는 7세이상 20세 이하의 자녀를 체크합니다.
따라서 7세이상 20세 이하의 자녀이더라도
연간 소득금액이 100만원을 초과하는 경우에는 체크하지 말아주세요."
								alt=" 갑근세 계산을 위한 항목으로
기본공제대상자에 해당하는 7세이상 20세 이하의 자녀를 체크합니다.
따라서 7세이상 20세 이하의 자녀이더라도
연간 소득금액이 100만원을 초과하는 경우에는 체크하지 말아주세요."></li>
						...
						<ul class="clsDragItemSort ui-sortable"
								...
								<ul id="grpDepeIdx0" class="grpDepe">
									...
									<li class="con3" style="padding-left: 7px; width: 78px"><select
										name="family[${status.index}].relation" id="frmEmdpRela0" class="G3">
											...
											<option value="아들"
												<c:if test="${MemberInfo.relation eq '아들' }">selected</c:if>>아들</option>
											<option value="딸"
												<c:if test="${MemberInfo.relation eq '딸' }">selected</c:if>>딸</option>
											<option value="부"
												<c:if test="${MemberInfo.relation eq '부' }">selected</c:if>>부</option>
											<option value="모"
												<c:if test="${MemberInfo.relation eq '모' }">selected</c:if>>모</option>
											<option value="형제"
												<c:if test="${MemberInfo.relation eq '형제' }">selected</c:if>>형제</option>
											<option value="자매"
												<c:if test="${MemberInfo.relation eq '자매' }">selected</c:if>>자매</option>
											<option value="장인"
												<c:if test="${MemberInfo.relation eq '장인' }">selected</c:if>>장인</option>
											<option value="장모"
												<c:if test="${MemberInfo.relation eq '장모' }">selected</c:if>>장모</option>
											<option value="시아버지"
												<c:if test="${MemberInfo.relation eq '시아버지' }">selected</c:if>>시아버지</option>
											<option value="시어머니"
												<c:if test="${MemberInfo.relation eq '시어머니' }">selected</c:if>>시어머니</option>
											<option value="조부"
												<c:if test="${MemberInfo.relation eq '조부' }">selected</c:if>>조부</option>
											<option value="조모"
												<c:if test="${MemberInfo.relation eq '조모' }">selected</c:if>>조모</option>
											<option value="손자"
												<c:if test="${MemberInfo.relation eq '손자' }">selected</c:if>>손자</option>
											<option value="손녀"
							...
							<ul id="grpDepeIdx3" class="grpDepe">
								<!-- ### G3 : 3 ### -->
								<li class="w_24 con3_check"><label class="label_check"
									for="grpDepeId3"><input type="checkbox"
										name="grpDepeId" id="grpDepeId3" class="G3" value="4"></label></li>
								<li class="con3" style="padding-left: 7px; width: 78px"><select
									name="frmEmdpRela" id="frmEmdpRela3" class="G3">
										<option value="">선택</option>
								...
								<li class="w_64 con3"><input name="frmEmdpName"
									id="frmEmdpName3" type="text" value="" class="white G3"
									style="width: 60px;"></li>
								<li class="con3" style="padding-left: 7px; width: 63px"><select
									name="frmEmdpNati" id="frmEmdpNati3" class="G3">
										<option value="">선택</option>
										<option value="내국인">내국인</option>
										<option value="외국인">외국인</option>
								</select></li>
								<li class="w_135 con3"><input name="frmEmdpUnq1"
									id="frmEmdpUnq13" type="text" value="" class="white G3"
									style="width: 55px;" maxlength="6"> - <input
									name="frmEmdpUnq2" id="frmEmdpUnq23" type="text" value=""
									class="white G3" style="width: 55px;" maxlength="7"></li>
								<li class="w_70 con3_check"><label class="label_check"
									for="frmEmdpDisa3"><input name="frmEmdpDisa"
										id="frmEmdpDisa3" type="checkbox" value="1" class="G3"></label></li>
								<li class="w_70 con3_check"><label class="label_check"
									for="frmEmdpDedu3"><input name="frmEmdpDedu"
										id="frmEmdpDedu3" type="checkbox" value="1" class="G3"></label></li>
								<li class="w_70 con3_check"><label class="label_check"
									for="frmEmdpInsu3"><input name="frmEmdpInsu"
										id="frmEmdpInsu3" type="checkbox" value="1" class="G3"
										style="height: 30px;"></label></li>
								<li class="w_70 con3_check"><label class="label_check"
									for="frmEmdpLvTg3"><input name="frmEmdpLvTg"
										id="frmEmdpLvTg3" type="checkbox" value="1" class="G3"></label></li>
								<li class="w_60 tit con3_check"><label class="label_check"
									for="frmEmdpMtTx3"><input name="frmEmdpMtTx"
										id="frmEmdpMtTx3" type="checkbox" value="1" class="G3"></label></li>
								<!-- 2016-02-11 갑근세 -->
								<li class="w_70 con3_check"><label class="label_check"
									for="frmEmdpMtCh3"><input name="frmEmdpMtCh"
										id="frmEmdpMtCh3" type="checkbox" value="1" class="G3"></label></li>
							</ul>
						</ul>
					</div>
				</ul>
				...
				<ul>
					<div id="table1">
						...
						<ul>
							<li class="w_24 tit"><label class="label_check"
								for="chkBoxGrpEmac"><input id="chkBoxGrpEmac"
									type="checkbox"></label></li>
						...
						<ul class="clsDragItemSort ui-sortable"
							...
							<form:form modelAttribute="UpdateAcademicAbilityVO"	action="/psyzon/updateacademic" method="post" id="academicForm">
								...
								<c:forEach var="MemberInfo"
									...
									<ul id="grpEmacIdx0" class="grpEmac">
										<!-- ### G4 0 ### -->
										<li class="w_24 con3_check "><label class="label_check"
											for="grpEmacId0"><input type="checkbox"
												name="grpEmacId" id="grpEmacId0" class="G4"></label></li>
										<li class="con3" style="padding-left: 7px; width: 78px">
											<select name="academic[${status.index}].a_type"
											id="frmEmacType0" class="G4">
												<option value="">선택</option>
												<option value="초등학교"
													<c:if test="${MemberInfo.a_type eq '초등학교' }">selected</c:if>>초등학교</option>
												<option value="중학교"
													<c:if test="${MemberInfo.a_type eq '중학교' }">selected</c:if>>중학교</option>
												<option value="고등학교"
													<c:if test="${MemberInfo.a_type eq '고등학교' }">selected</c:if>>고등학교</option>
												<option value="대학교"
													<c:if test="${MemberInfo.a_type eq '대학교' }">selected</c:if>>대학교</option>
												<option value="석사"
													<c:if test="${MemberInfo.a_type eq '석사' }">selected</c:if>>석사</option>
												<option value="박사"
													<c:if test="${MemberInfo.a_type eq '박사' }">selected</c:if>>박사</option>
										</select>
										</li>
										<li class="w_110 con3"><input
											name="academic[${status.index}].a_entrance_year"
										...
										<li class="w_110 con3"><input
											name="academic[${status.index}].a_graduate_year"
										...
										<li class="con3" style="width: 253px;"><input
											name="academic[${status.index}].a_school_name"
											id="frmEmacSchl0" type="text"
											value="${MemberInfo.a_school_name}" class="white G4"
											style="width: 240px;"></li>
										<li class="w_140 con3"><input
											name="academic[${status.index}].a_major" id="frmEmacMajr0"
											type="text" value="${MemberInfo.a_major}" class="white G4"
											style="width: 120px;"></li>
										<li class="con3" style="padding-left: 7px; width: 63px">
											<select name="academic[${status.index}].a_finish"
											id="frmEmamCmpl0" class="G4">
												<option value="">선택</option>
												<option value="졸업"
													<c:if test="${MemberInfo.a_finish eq '졸업' }">selected</c:if>>졸업</option>
												<option value="수료"
													<c:if test="${MemberInfo.a_finish eq '수료' }">selected</c:if>>수료</option>
												<option value="자퇴"
													<c:if test="${MemberInfo.a_finish eq '자퇴' }">selected</c:if>>자퇴</option>
												<option value="재학중"
													<c:if test="${MemberInfo.a_finish eq '재학중' }">selected</c:if>>재학중</option>
										</select>
										</li>
							...
							<ul id="grpEmacIdx2" class="grpEmac">
								<!-- ### G4 2 ### -->
								<li class="w_24 con3_check "><label class="label_check"
									for="grpEmacId2"><input type="checkbox"
										name="grpEmacId" id="grpEmacId2" class="G4"></label></li>
								<li class="con3" style="padding-left: 7px; width: 78px"><select
									name="frmEmacType" id="frmEmacType2" class="G4">
										<option value="">선택</option>
								...
								<li class="w_110 con3"><input name="frmEmacJinD1"
									id="frmEmacJinD12" type="text" value="" class="white G4"
									style="width: 30%;" maxlength="4"> 년&nbsp;&nbsp; <input
									name="frmEmacJinD2" id="frmEmacJinD22" type="text" value=""
									class="white G4" style="width: 17%;" maxlength="2"> 월</li>
								<li class="w_110 con3"><input name="frmEmacGinD1"
									id="frmEmacGinD12" type="text" value="" class="white G4"
									style="width: 30%;" maxlength="4"> 년&nbsp;&nbsp; <input
									name="frmEmacGinD2" id="frmEmacGinD22" type="text" value=""
									class="white G4" style="width: 17%;" maxlength="2"> 월</li>
								<li class="con3" style="width: 253px;"><input
									name="frmEmacSchl" id="frmEmacSchl2" type="text" value=""
									class="white G4" style="width: 240px;"></li>
								<li class="w_140 con3"><input name="frmEmacMajr"
									id="frmEmacMajr2" type="text" value="" class="white G4"
									style="width: 120px;"></li>
								<li class="con3" style="padding-left: 7px; width: 63px"><select
									name="frmEmamCmpl" id="frmEmamCmpl2" class="G4">
										<option value="">선택</option>
   ...
   <option value="기타"<c:if test="${MemberInfo.ms_group eq '기타' }">selected</c:if>>기타</option>
    ...
    <!-- //병역: G6// -->
				...
				<ul class="emreg_btn c">
					...
					<input name="btnEmplSave" id="btnEmplSave" type="image"
						value="저장하기"
						src="https://img.payzon.co.kr/_commonImg/btn_img_save_s.png"
						hspace="5" alt="저장하기" title="저장하기" />
					<input name="btnEmplSaveCancel" id="btnEmplSaveCancel" type="image"
						value="취소하기"
						src="https://img.payzon.co.kr/_commonImg/btn_img_cancle_s.png"
						hspace="5" alt="취소하기" title="취소하기">
					<input name="btnLinkList" id="btnLinkList" type="image" value="리스트"
						src="https://img.payzon.co.kr/_commonImg/btn_img_list_s.png"
						hspace="5" alt="리스트" title="리스트">
					<a href="/pzPersonnel/employeeIns.php"><img
						src="https://img.payzon.co.kr/_commonImg/btn_new_employee_s1.png"
						hspace="5" alt="신규사원등록하기" title="신규사원등록하기"></a>
				</ul>
	...
	<!--   <script>
    document.getElementById('btnEmplSave').addEventListener('click', function() {
        submitForm();
    });
	...
	<!-- footer -->
	<footer>
		<iframe ref="nofollow" name="iFrmMulti" id="iFrmMulti"
			src="about:blank" tabindex="-1" width="0px" height="0px"
			frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"></iframe>
		<iframe ref="nofollow" name="iFrmLog" id="iFrmLog" src="about:blank"
			tabindex="-1" width="0px" height="0px" frameborder="0" scrolling="no"
			marginheight="0" marginwidth="0"></iframe>
		<!--  -->
		<div id="main_footer">
			<img src="https://img.payzon.co.kr/_commonImg/bottom_2023.gif"
				usemap="#footer">
		</div>

		<map name="footer">
			<area shape="rect" coords="456,9,627,87"
				href="/pzServiceGuide/customerFAQList.php" alt="faq" title="faq">
			<area shape="rect" coords="636,12,819,87"
				href="/pzMyPage/onlineQnAEdit.php" alt="qna" title="qna">
			<area shape="rect" coords="827,12,991,86"
				href="/pzServiceManual/manualStart.php" alt="이용안내" title="이용안내">
			<area shape="rect" coords="998,12,1150,86"
				href="/pzServiceGuide/memberPayment.php" alt="충전&amp;결제"
				title="충전&amp;결제">
		</map>
	</footer>
	...
	<!-- <iframe ref="nofollow" name="iFrmMulti" id="iFrmMulti" src="/_commonLog/logProc.php?pc=A001" tabindex="-1" width="0px" height="0px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" style="display:none;"></iframe>
        <iframe ref="nofollow" name="iFrmLog" id="iFrmLog" src="/_commonLog/logProc.php?pc=A002" width="0px" height="0px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" style="display:none;"></iframe> -->
	<!-- /_commonLog/logProc.php?pc=A001 -->
	<!-- // footer -->
	...
	<link rel="stylesheet" type="text/css"
		href="//cdn.poesis.kr/post/search.css?v=3.5.0">
	<div class="postcodify_popup_background" style="display: none;"></div>
	<div class="postcodify_popup_layer" data-version="3.5.0"
		style="display: none;">
		<div class="postcodify_controls"></div>
		<div class="postcodify_displays">
			<div class="postcodify_results"></div>
			<div class="postcodify_help">
				...
				<p>정확한 검색을 위한 팁</p>
				<ul>
					<li><span>시·군·구·읍·면 등은 쓰지 않아도 되지만,</span> <span>쓰실 경우
							반드시 띄어쓰기를 해 주세요.</span></li>
					<li><span>도로명에 포함된 "××번길" 등 숫자도</span> <span>잊지 말고 써
							주세요.</span></li>
					<li><span>건물명보다는 번호가 포함된 정확한 주소로</span> <span>검색하는 것이
							빠르고 정확합니다.</span></li>
				</ul>
			</div>
		</div>
		<div class="postcodify_logo">
			P O W E R E D &nbsp; B Y &nbsp; <a
				href="http://postcodify.poesis.kr/">P O S T C O D I F Y</a>
		</div>
	</div>
</body>
</html>